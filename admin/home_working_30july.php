...
<?php $activeTab = $_GET['tab'] ?? 'main';?>
<ul class="nav nav-tabs mb-3">
  <li class="nav-item">
    <a class="nav-link <?= $activeTab == 'main' ? 'active' : '' ?>" href="?tab=main">Dashboard</a>
  </li>
  <li class="nav-item">
    <a class="nav-link <?= $activeTab == 'new' ? 'active' : '' ?>" href="?tab=new">New Dashboard</a>
  </li>
</ul>

<?php
if ($activeTab == 'new') {
    include 'dashboard_new.php'; // This is new dashboard layout
} else { 
?>
                ...
                <div class="row">
                    ...
                    if (in_array($_settings->userdata('type'), [1, 3])) {
                        ...
                        $cards = [
                            ...
                            ["Total Leads", $total_leads, "secondary", "fa-database"],
                            ["Today's Follow-ups", $todays_followups, "info", "fa-calendar-day"],
                            ["Upcoming Follow-ups", $upcoming_followups, "warning", "fa-calendar-plus"],
                            ["Overdue Follow-ups", $overdue_followups, "danger", "fa-exclamation-circle"],
            ...
            <?php if (in_array($_settings->userdata('type'), [1, 3])): ?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    switch ($filter) {
                                        case 'week':
                                            $where = "YEARWEEK(l.date_created, 1) = YEARWEEK(CURDATE(), 1)";
                                            break;
                                        case 'month':
                                            $where = "MONTH(l.date_created) = MONTH(CURDATE()) AND YEAR(l.date_created) = YEAR(CURDATE())";
                                            break;
                                        case 'today':
                                        default:
                                    ...
                                    $qry = $conn->query("SELECT l.*, c.company_name as client, c.website, c.city, c.state, c.country, c.follow_up_date, c.calling_date, u.firstname, u.lastname 
                                            FROM `lead_list` l 
                                    ...
                                    <form method="get" class="mb-3">
                                        ...
                                        <select name="filter" id="filter" class="form-control d-inline-block w-auto" onchange="this.form.submit()">
                                        ...
                                        <?php if ($role == 1 || $role == 3): ?>
                                            ...
                                            <select name="user_id" id="user_id" class="form-control d-inline-block w-auto mr-3" onchange="this.form.submit()">
                ...
                ");
                    ...
                    <div class="col-md-3 mt-2">
                        <div class="card shadow-sm border-0 rounded-4 p-3" style="background-color: #f9f9f9;">
                            <h6 class="text-center mb-3 font-weight-bold text-secondary">Lead Status</h6>
...
<style>
    ...
    .bg-light-info {
        background-color: rgba(23, 162, 184, 0.1); /* Bootstrap info color with transparency */
    }
