...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/opt/lampp/htdocs/lms/python/bin',
    'BINLIBDEST': '/opt/lampp/htdocs/lms/python/lib/python3.13',
    ...
    'CONFIG_ARGS': "'--prefix=/opt/lampp/htdocs/lms/python/'",
    'CONFINCLUDEDIR': '/opt/lampp/htdocs/lms/python/include',
    'CONFINCLUDEPY': '/opt/lampp/htdocs/lms/python/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/opt/lampp/htdocs/lms/python/Python-3.13.4/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/opt/lampp/htdocs/lms/python/Python-3.13.4/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.13 LCOV report [commit $(shell )]"',
    'CPPFLAGS': '-I. -I./Include',
    'CXX': 'g++ -pthread',
    'DESTDIRS': '/opt/lampp/htdocs/lms/python /opt/lampp/htdocs/lms/python/lib /opt/lampp/htdocs/lms/python/lib/python3.13 /opt/lampp/htdocs/lms/python/lib/python3.13/lib-dynload',
    'DESTLIB': '/opt/lampp/htdocs/lms/python/lib/python3.13',
    'DESTPATH': '',
    'DESTSHARED': '/opt/lampp/htdocs/lms/python/lib/python3.13/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/opt/lampp/htdocs/lms/python/bin/python3.13',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'INCLDIRSTOMAKE': '/opt/lampp/htdocs/lms/python/include /opt/lampp/htdocs/lms/python/include /opt/lampp/htdocs/lms/python/include/python3.13 /opt/lampp/htdocs/lms/python/include/python3.13',
    'INCLUDEDIR': '/opt/lampp/htdocs/lms/python/include',
    'INCLUDEPY': '/opt/lampp/htdocs/lms/python/include/python3.13',
    ...
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/opt/lampp/htdocs/lms/python/lib/python3.13',
    'LIBDIR': '/opt/lampp/htdocs/lms/python/lib',
    ...
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/opt/lampp/htdocs/lms/python/lib/pkgconfig',
    'LIBPL': '/opt/lampp/htdocs/lms/python/lib/python3.13/config-3.13-x86_64-linux-gnu',
    'LIBPYTHON': '',
    ...
    'VERSION': '3.13',
    'WASM_ASSETS_DIR': './opt/lampp/htdocs/lms/python',
    'WASM_STDLIB': './opt/lampp/htdocs/lms/python/lib/python3.13/os.py',
    'WHEEL_PKG_DIR': '',
    'WINDOW_HAS_FLAGS': 0,
    ...
    'abs_builddir': '/opt/lampp/htdocs/lms/python/Python-3.13.4',
    'abs_srcdir': '/opt/lampp/htdocs/lms/python/Python-3.13.4',
    'datarootdir': '/opt/lampp/htdocs/lms/python/share',
    'exec_prefix': '/opt/lampp/htdocs/lms/python',
