...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "depends": [
            "/opt/python/cp313-cp313/include/python3.13/Python.h",
            "/opt/python/cp313-cp313/include/python3.13/datetime.h",
            "/opt/python/cp313-cp313/include/python3.13/pythread.h",
            "srsly/msgpack/pack.h"
        ],
        "include_dirs": [
            "srsly/msgpack",
            "/opt/python/cp313-cp313/include/python3.13",
            ".",
            "srsly"
        ],
        "language": "c++",
